...
## World activities and rewards: 9 September 2026

The catalogue now has 249 entries. The original 207 IDs and their saved progress remain compatible; 42 additional IDs represent individual world-map locations: 14 rescues, 15 bandit camps and 13 soldier camps.

- [PowerPyx: Person in Danger](https://www.powerpyx.com/blood-of-dawnwalker-all-person-in-danger-locations/) documents 14 locations, skill-point rewards, availability during day/night and encounters remaining after walking away. Its 5 September comment update confirms that rescues began advancing time after a patch; the reader reports one segment. The user independently reported receiving **1 skill point** for a rescue on 9 September. The catalogue records 1 SP and 1 segment for this activity type; XP is not inferred.
- [Dawnwalker Wiki map](https://dawnwalkerwiki.com/maps/vale-sangora) provides the public map-location IDs and coordinates, with each pin pointing to its original MapGenie source. The 14/15/13 counts agree with [PowerPyx rescues](https://www.powerpyx.com/blood-of-dawnwalker-all-person-in-danger-locations/), [bandit camps](https://www.powerpyx.com/blood-of-dawnwalker-all-bandit-camp-locations/) and [soldier camps](https://www.powerpyx.com/blood-of-dawnwalker-all-soldier-camp-locations/). Display labels use the nearest mapped shrine and a computed compass direction, not invented official activity names. Unconfirmed region membership stays at the broader Vale Sangora level. Individual location IDs, source URLs and coordinate calculations are retained in local research.
- [PC Gamer: Swordmastery manuals](https://www.pcgamer.com/games/rpg/blood-of-dawnwalker-swordmastery-ability-manual-locations/) supports six camp manual finds: Broad Swing, Swiftness, Adrenaline Rush, Artery Strike, Walking Fortress and Dirty Trick. Other camp chests are labelled variable loot; specific items, quantities and completion XP are not invented.
- [PowerPyx: Ancient Circles](https://www.powerpyx.com/blood-of-dawnwalker-all-ancient-circle-locations/) gives 1 segment per trial, during daylight. [PowerPyx: Wisps](https://www.powerpyx.com/blood-of-dawnwalker-all-will-o-the-wisps-locations/) gives 1 segment per treasure. [PowerPyx: Court activities](https://www.powerpyx.com/blood-of-dawnwalker-all-court-activity-locations/) gives 1 segment for each named Ambrus cellar. These override the conflicting 0/2/3 values imported from MetaBot. Existing reward entries remain unless explicitly supplemented.
- [NightlyGamingBinge: Destroyed Shrines](https://nightlygamingbinge.com/the-blood-of-the-dawnwalker-destroyed-shrines-questline/) distinguishes 1-segment restoration from separate 1-segment camp encounters, including Western Slopes, Maragir Wealds and Crossroads Inn. The camp and restoration are individual plan items; possessing a heart does not force another camp completion. Twenty restoration entries gain their fast-travel unlock reward. [Gamer Guides: A Hidden Shrine](https://www.gamerguides.com/the-blood-of-dawnwalker/database/journal/activities/destroyed-shrines-a-hidden-shrine) also confirms 1 segment for the indoor shrine.
- [AllThingsHow: Bandit camps](https://allthings.how/the-blood-of-dawnwalker-all-15-bandit-camp-locations-and-treasure-maps/) records camp clearance and treasure excavation as separate 1-segment actions. Seven existing treasure-map entries now charge for excavation alone and show 14 named finds from [PowerPyx’s treasure guide](https://www.powerpyx.com/blood-of-dawnwalker-all-treasure-map-locations-solutions/), labelled as reported loot. The two soldier camps associated with the documented shrine routes have a confirmed cost; the other eleven remain unknown rather than inheriting that price without verification.
- [Gamer Guides: Hidden & Safe](https://www.gamerguides.com/the-blood-of-dawnwalker/database/journal/activities/destroyed-shrines-hidden-and-safe) lists 1 segment, but [the walkthrough](https://allthings.how/destroyed-shrines-hidden-safe-walkthrough-in-the-blood-of-dawnwalker/) describes a shared investigation and three separate restorations. [Enshrined Obsession](https://www.gamerguides.com/the-blood-of-dawnwalker/database/journal/quests/enshrined-obsession) already accounts for the attic investigation. Hidden & Safe therefore retains an unknown independent cost and shows the three heart rewards; none of the related entries is silently charged twice.

The map export from MetaBot was unavailable during this pass; only its page-level counts were used. No new mandatory quest dependency was inferred from spatial proximity. Research, provenance, unchanged-file checks and validation reports are retained under `research/world-activities` locally; raw captures are not published.
