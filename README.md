...
User-supplied game cards cover 20 Witchcraft perks, all 10 Witchcraft abilities and all 29 Swordmastery skills (96 ranks). The update confirms starting/manual ranks, keeps seven Anytime perks active at night, and supplies observed numerical effects, cooldowns and casting costs. The additional first-rank screenshot confirms Astral Communion I at +0.4% Damage per place of power. All book requirements are now established. Charge needs a book at every rank, including I; the player had already read its first book before the screenshot. Dirty Trick now shows the observed 110 / 137 / 165 / 192 Damage, and four Swordmastery cards include cooldowns and charge costs. Font of Life is unchanged.
